...
def run_logo(pssm_json: str, name: str, filepath: str):
    """Generate a logo into dir FILEPATH from a PSSM in JSON."""
    with open(pssm_json) as f:
        pssm = json.load(f)
    PSSMtoLOGO(pssm, name, filepath)
